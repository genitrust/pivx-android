...
import pivx.org.pivxwallet.wallofcoins.selling_wizard.adapters.SellingWizardAddressListAdapter;
...
public class SellingWizardAddressListingFragment extends SellingWizardBaseFragment {
    ...
    private RecyclerView recycler_sell_piv;
    ...
    private void setAdapter() {
        ...
        recycler_sell_piv.setAdapter(adapter);
    }

    private void init() {
        recycler_sell_piv = (RecyclerView) rootView.findViewById(R.id.recycler_sell_piv);
        recycler_sell_piv.setLayoutManager(new LinearLayoutManager(mContext));
    ...
    private void getAddressList() {
        ...
        SellingAPIClient.createService(interceptor, getActivity()).getAddressListing().
                enqueue(new Callback<ArrayList<SellingWizardAddressListRespVo>>() {
                    @Override
                    public void onResponse(Call<ArrayList<SellingWizardAddressListRespVo>> call, Response<ArrayList<SellingWizardAddressListRespVo>> response) {
