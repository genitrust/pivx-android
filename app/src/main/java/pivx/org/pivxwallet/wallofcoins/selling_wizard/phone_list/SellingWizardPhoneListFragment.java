...
import pivx.org.pivxwallet.wallofcoins.selling_wizard.adapters.SellingWizardPhoneListAdapter;
...
import pivx.org.pivxwallet.wallofcoins.selling_wizard.common.SellingWizardPhoneUtil;
import pivx.org.pivxwallet.wallofcoins.selling_wizard.contact_details.SellingWizardContactDetailsFragment;
...
import pivx.org.pivxwallet.wallofcoins.selling_wizard.models.SellingWizardPhoneListVO;
...
public class SellingWizardPhoneListFragment extends SellingWizardBaseFragment implements View.OnClickListener {
    ...
    private void getDevice() {
        ...
        SellingAPIClient.createService(interceptor, mContext).getDevice().enqueue(new Callback<List<SellingWizardCreateDeviceVo>>() {
            @Override
            public void onResponse(Call<List<SellingWizardCreateDeviceVo>> call, Response<List<SellingWizardCreateDeviceVo>> response) {
                progressBar.setVisibility(View.GONE);
