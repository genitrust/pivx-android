...
import pivx.org.pivxwallet.wallofcoins.selling_wizard.instruction.SellingWizardInstructionFragment;
...
public class SellingWizardVerifCodeFragment extends BuyingWizardBaseFragment implements View.OnClickListener {
    ...
    private void verifyAd() {
        ...
        if (NetworkUtil.isOnline(mContext)) {
            ...
            SellingAPIClient.createService(interceptor, mContext).verifyAd(verifyAdReq).enqueue(new Callback<SellingWizardVerifyAdResp>() {
                @Override
    ...
    private void navigateToLocation() {
        SellingWizardInstructionFragment sellingWizardInstructionFragment = new SellingWizardInstructionFragment();
        ((SellingWizardBaseActivity) mContext).replaceFragment(sellingWizardInstructionFragment, true, true);
    }
